...
const transformChoices = [
    ...
    { name: 'Convert them to Pascal-case', value: 'pc' },
    { name: 'Convert them to Camel-case', value: 'cc' },
    new inquirer.Separator(),
...
module.exports = {
    questions: [
        ...
        createTransformPrompt('transformServiceName', 'How should service names be changed?'),
